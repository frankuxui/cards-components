...
function App () {
  ...
  return (
    <>
      ...
      <OpenGraph title='Cards components' />
      <div className='App pt-16 pb-16 mx-5 '>
        ...
        <div className='box-border m-auto max-w-[80rem] 3xl:max-w-[120rem] columns-1xs sm:columns-2xs md:columns-2 lg:columns-3 xl:columns-4 2xl:columns-4 3xl:columns-6'>
          ...
          <div className='break-inside flex flex-col justify-between rounded-xl mb-4 text-sm overflow-hidden bg-white dark:bg-slate-800 dark:text-slate-50'>
            ...
            <div className='flex justify-between p-4'>
              <div className='flex items-center space-x-2'>
                ...
                <span className='font-medium text-base'>Paint</span>
              </div>
          ...
          {/** card */}
          <div className='break-inside flex flex-col justify-between overflow-hidden rounded-xl mb-4 text-white bg-[#0A171B]'>
            <div className='p-6 space-y-3'>
              <h1 className='text-4xl font-extrabold leading-snug text-transparent bg-clip-text bg-gradient-to-tr from-[#FA4420] to-[#f0ac19]'>
                New card
                <br />
                designs
              </h1>
              <p className='text-[#BDBDBD]'>Minim dolor in amet nulla laboris enim dolore.</p>
            </div>
          ...
          {/** card */}
          <div className='break-inside flex flex-col justify-between overflow-hidden rounded-xl space-y-2 p-6 text-sm mb-4 text-black bg-white dark:bg-slate-800 dark:text-slate-100'>
            <div className='flex items-center space-x-4'>
              <img className='flex-none w-10 h-10 rounded-full object-cover' src='https://randomuser.me/api/portraits/men/11.jpg' alt='avatar' />
              <div className='flex-auto'>
                <a href='#' className='font-bold block dark:text-white'>Ralph Edwards</a>
                <span className='text-slate-500 dark:text-slate-400'>Admin</span>
              </div>
            </div>
            <div className='flex items-center justify-between'>
              <div className='relative'>
                <span className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 font-medium text-lg'>88%</span>
                <svg width='95' height='95' viewBox='0 0 164 164' fill='none' xmlns='http://www.w3.org/2000/svg'>
                  <path d='M148.37 130.493C159.89 114.682 165.339 95.2547 163.721 75.7588C162.103 56.263 153.526 37.9996 139.557 24.304C125.588 10.6083 107.158 2.3943 87.6343 1.16188C68.1103 -0.0705276 48.7943 5.76093 33.214 17.5913C17.6336 29.4217 6.82839 46.4616 2.77161 65.5993C-1.28516 84.7369 1.67719 104.695 11.1177 121.83C20.5581 138.964 35.8468 152.131 54.1917 158.926C72.5366 165.721 92.7136 165.69 111.038 158.84L102.477 135.938C89.6495 140.733 75.5256 140.754 62.6842 135.998C49.8428 131.242 39.1407 122.025 32.5324 110.031C25.924 98.0367 23.8504 84.0658 26.6901 70.6695C29.5299 57.2732 37.0935 45.3452 47.9998 37.0639C58.906 28.7827 72.4272 24.7006 86.094 25.5633C99.7608 26.426 112.661 32.1758 122.44 41.7628C132.218 51.3497 138.222 64.1341 139.355 77.7812C140.487 91.4283 136.673 105.027 128.609 116.095L148.37 130.493Z' fill='#f0f5fc' />
                  <path d='M145.973 110.252C152.159 112.957 155.055 120.23 151.457 125.942C147.387 132.402 142.42 138.275 136.687 143.377C127.901 151.198 117.526 157.024 106.275 160.455C95.0243 163.886 83.164 164.842 71.509 163.255C59.854 161.669 48.6805 157.579 38.7559 151.266C28.8313 144.952 20.3909 136.565 14.0145 126.681C7.63805 116.797 3.47666 105.65 1.81617 94.0052C0.155686 82.3606 1.03546 70.4944 4.39505 59.222C6.58709 51.867 9.80095 44.8785 13.9267 38.455C17.5755 32.7742 25.3903 32.315 30.462 36.7718V36.7718C35.5337 41.2285 35.8935 48.9124 32.6172 54.8159C30.6185 58.4173 29.0098 62.2351 27.8265 66.2054C25.4748 74.0961 24.859 82.4024 26.0213 90.5537C27.1837 98.7049 30.0966 106.508 34.5602 113.427C39.0237 120.346 44.9319 126.217 51.8791 130.636C58.8263 135.055 66.6478 137.918 74.8063 139.029C82.9648 140.139 91.267 139.47 99.1426 137.069C107.018 134.667 114.281 130.588 120.431 125.114C123.525 122.36 126.301 119.284 128.716 115.948C132.675 110.478 139.787 107.547 145.973 110.252V110.252Z' fill='#42c5cf' />
                  <path d='M48.3573 142.777C45.0297 148.652 37.4973 150.783 32.1858 146.615C27.0044 142.549 22.323 137.86 18.2521 132.644C11.667 124.207 6.8083 114.556 3.95326 104.241C1.09823 93.9258 0.302819 83.1496 1.61245 72.5273C2.92209 61.905 6.31112 51.6446 11.586 42.3321C16.861 33.0195 23.9185 24.8371 32.3556 18.2521C40.7928 11.667 50.4444 6.80829 60.7593 3.95326C71.0742 1.09822 81.8504 0.302819 92.4727 1.61246C99.0395 2.42208 105.468 4.0264 111.62 6.37969C117.926 8.79203 119.97 16.3484 116.643 22.2231V22.2231C113.315 28.0979 105.866 30.0186 99.4185 28.0164C96.1839 27.0119 92.8585 26.2952 89.4809 25.8787C82.0453 24.962 74.5019 25.5188 67.2815 27.5173C60.0611 29.5158 53.305 32.9169 47.399 37.5265C41.4929 42.136 36.5527 47.8637 32.8602 54.3825C29.1678 60.9012 26.7955 68.0835 25.8787 75.5191C24.962 82.9547 25.5188 90.4981 27.5173 97.7185C29.5158 104.939 32.9169 111.695 37.5265 117.601C39.6204 120.284 41.945 122.767 44.4696 125.025C49.5023 129.526 51.6849 136.902 48.3573 142.777V142.777Z' fill='#d00b5a' />
                  <path d='M73.082 151.132C72.1641 157.821 65.9548 162.588 59.4781 160.681C51.5056 158.333 43.9157 154.773 36.982 150.105C26.6567 143.152 18.061 133.928 11.8543 123.138C5.64766 112.348 1.99494 100.28 1.17642 87.8593C0.626755 79.5186 1.36496 71.1677 3.34369 63.0957C4.95118 56.5382 12.1938 53.5674 18.4375 56.1369V56.1369C24.6812 58.7063 27.5154 65.8574 26.3325 72.5047C25.528 77.0249 25.2696 81.6405 25.5735 86.2515C26.1465 94.946 28.7034 103.394 33.048 110.947C37.3927 118.499 43.4097 124.957 50.6374 129.823C54.4706 132.404 58.5904 134.501 62.9022 136.078C69.2431 138.398 73.9999 144.443 73.082 151.132V151.132Z' fill='#82ca06' />
                  <path d='M87.4039 151.601C87.8818 158.336 82.7862 164.279 76.0557 163.745C67.3655 163.056 58.8153 160.974 50.7385 157.556C42.6617 154.138 35.2146 149.45 28.6693 143.692C23.5999 139.233 24.3178 131.438 29.4848 127.092V127.092C34.6518 122.746 42.3028 123.542 47.6481 127.667C51.5077 130.645 55.7464 133.126 60.2669 135.039C64.7875 136.952 69.5198 138.267 74.3448 138.964C81.0271 139.929 86.9259 144.866 87.4039 151.601V151.601Z' fill='#5b0fe8' />
                </svg>
              </div>
              <div className='flex flex-col'>
                <ul className='list-none space-y-[2px]'>
                  <li className='flex items-center justify-start space-x-2'>
                    <span className='w-3 h-3 rounded-sm bg-[#42c5cf]' />
                    <span>Documents</span>
                  </li>
                  <li className='flex items-center justify-start space-x-2'>
                    <span className='w-3 h-3 rounded-sm bg-[#d00b5a]' />
                    <span>Videos</span>
                  </li>
                  <li className='flex items-center justify-start space-x-2'>
                    <span className='w-3 h-3 rounded-sm bg-[#82ca06]' />
                    <span>Photos</span>
                  </li>
                  <li className='flex items-center justify-start space-x-2'>
                    <span className='w-3 h-3 rounded-sm bg-[#5b0fe8]' />
                    <span>Music</span>
                  </li>
                </ul>
              </div>
            ...
            <div className=''>
              ...
              <div className='flex items-end justify-between mt-3'>
                <div className='flex flex-col space-y-2'>
                  ...
                  <div className='flex items-center justify-start space-x-2'>
                    <div className='flex items-center pl-1'>
                      <span className='w-5 h-5 -m-1 rounded-full bg-[#42c5cf]' />
                      <span className='w-5 h-5 -m-1 rounded-full bg-[#d00b5a]' />
                      <span className='w-5 h-5 -m-1 rounded-full bg-[#82ca06]' />
                      <span className='w-5 h-5 -m-1 rounded-full bg-[#5b0fe8]' />
                    </div>
                    <span className='text-lg font-medium'>137GB</span>
                  </div>
                </div>
                <button className='flex items-center justify-center rounded-full w-10 h-10 transition-all bg-[#eff6ff] text-[#1a222c]'>
                  <svg width='20' height='20' viewBox='0 0 24 24'>
                    <path fill='currentColor' d='M12,15.5A3.5,3.5 0 0,1 8.5,12A3.5,3.5 0 0,1 12,8.5A3.5,3.5 0 0,1 15.5,12A3.5,3.5 0 0,1 12,15.5M19.43,12.97C19.47,12.65 19.5,12.33 19.5,12C19.5,11.67 19.47,11.34 19.43,11L21.54,9.37C21.73,9.22 21.78,8.95 21.66,8.73L19.66,5.27C19.54,5.05 19.27,4.96 19.05,5.05L16.56,6.05C16.04,5.66 15.5,5.32 14.87,5.07L14.5,2.42C14.46,2.18 14.25,2 14,2H10C9.75,2 9.54,2.18 9.5,2.42L9.13,5.07C8.5,5.32 7.96,5.66 7.44,6.05L4.95,5.05C4.73,4.96 4.46,5.05 4.34,5.27L2.34,8.73C2.21,8.95 2.27,9.22 2.46,9.37L4.57,11C4.53,11.34 4.5,11.67 4.5,12C4.5,12.33 4.53,12.65 4.57,12.97L2.46,14.63C2.27,14.78 2.21,15.05 2.34,15.27L4.34,18.73C4.46,18.95 4.73,19.03 4.95,18.95L7.44,17.94C7.96,18.34 8.5,18.68 9.13,18.93L9.5,21.58C9.54,21.82 9.75,22 10,22H14C14.25,22 14.46,21.82 14.5,21.58L14.87,18.93C15.5,18.67 16.04,18.34 16.56,17.94L19.05,18.95C19.27,19.03 19.54,18.95 19.66,18.73L21.66,15.27C21.78,15.05 21.73,14.78 21.54,14.63L19.43,12.97Z' />
                  </svg>
                </button>
          ...
          <div className='break-inside flex flex-col justify-between overflow-hidden rounded-xl mb-4 text-sm bg-white dark:bg-slate-800 dark:text-slate-50'>
            ...
            <div className='p-6 flex flex-col justify-between'>
              <div className='flex flex-col items-start space-y-1'>
                ...
                <h2 className='text-xl font-bold'>Hotel, Cromwell International</h2>
              </div>
          ...
          <div className='break-inside p-4 flex flex-col justify-between rounded-xl mb-4 text-sm bg-white dark:bg-slate-800 dark:text-slate-50'>
            <div className='space-y-4'>
              <div className='flex items-center space-x-4'>
                ...
                <div className='flex-auto'>
                  <a href='#' className='text-base font-bold block dark:text-white'>Angelina Mconoor</a>
                  <span className='text-slate-500 dark:text-slate-400'>Dog Trainer</span>
                </div>
              </div>
          ...
          <div className='break-inside p-4 flex flex-col justify-between rounded-xl mb-4 text-sm bg-white dark:bg-slate-800 dark:text-slate-50 group'>
            <div className='flex justify-between'>
              <div className='flex items-center space-x-2'>
                ...
                <div className='flex-auto'>
                  <a href='#' className='text-lg font-bold block dark:text-white'>Paint</a>
                </div>
              </div>
              <div className='flex items-center space-x-1 text-slate-500 dark:text-slate-400'>
                <svg viewBox='0 0 24 24' width='18' height='18'>
          ...
          <div className='break-inside p-4 flex flex-col justify-between rounded-xl mb-4 text-sm bg-white dark:bg-slate-800 dark:text-slate-50'>
            <div className='space-y-4'>
              ...
              <div className='py-4 space-y-4'>
                <h4 className='text-base font-bold leading-snug'>The care of animals and our planet only depends on you</h4>
          ...
          <div className='break-inside relative rounded-xl mb-4 text-sm p-6 bg-white dark:bg-slate-800 dark:text-white'>
            ...
            <div className='flex justify-between items-center'>
              ...
              <span className='flex justify-center items-center w-10 h-10 rounded-xl bg-black text-white dark:bg-white dark:text-black'>
                <svg width='18' height='18' viewBox='0 0 22 21' xmlns='http://www.w3.org/2000/svg'>
                  <path d='M6 1.23792C3.239 1.23792 1 3.45391 1 6.18791C1 8.39491 1.875 13.6329 10.488 18.9279C10.6423 19.0218 10.8194 19.0714 11 19.0714C11.1806 19.0714 11.3577 19.0218 11.512 18.9279C20.125 13.6329 21 8.39491 21 6.18791C21 3.45391 18.761 1.23792 16 1.23792C13.239 1.23792 11 4.23792 11 4.23792C11 4.23792 8.761 1.23792 6 1.23792Z' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
                </svg>
              </span>
            </div>
          ...
          {/** card */}
          <div className='break-inside divide-y divide-slate-400/20 mb-4 rounded-lg bg-white text-[0.8125rem] leading-5 text-slate-900 shadow-xl shadow-black/5 dark:bg-slate-800 dark:text-white'>
          ...
          <div className='break-inside p-4 flex flex-col justify-between rounded-2xl mb-4 space-y-8 bg-white text-black dark:bg-slate-800 dark:text-white'>
            <div className='flex justify-between items-start'>
              <div className='flex items-center justify-start space-x-2'>
                ...
                <h3 className='text-base font-medium'>Freelancers</h3>
              </div>
              <button className='flex items-center justify-center rounded-full p-1 transition-all hover:bg-slate-200 dark:hover:bg-slate-700'>
                <svg width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                  <path d='M12,16A2,2 0 0,1 14,18A2,2 0 0,1 12,20A2,2 0 0,1 10,18A2,2 0 0,1 12,16M12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12A2,2 0 0,1 12,10M12,4A2,2 0 0,1 14,6A2,2 0 0,1 12,8A2,2 0 0,1 10,6A2,2 0 0,1 12,4Z' fill='currentColor' />
          ...
          {/** card */}
          <div className='break-inside flex flex-col justify-between overflow-hidden rounded-xl mb-4 text-sm bg-black text-white'>
            <div className='relative flex flex-col justify-between text-white bg-green-900 min-h-[14rem]'>
                ...
                <div className='flex justify-between h-full flex-col'>
                  <div className='p-6 bg-gradient-to-t from-[#00000000] to-[#000000]'>
                    <div className='flex items-start flex-row justify-between'>
                      <div className='mr-auto'>
                        <h3 className='text-xl font-bold'>Good night Frank</h3>
          ...
          <div className='break-inside overflow-hidden relative rounded-2xl mb-4 text-white saturate-0 group'>
            <img src='https://images.pexels.com/photos/13159253/pexels-photo-13159253.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='Running' className='w-full h-[26rem] object-cover transition-all group-hover:scale-[1.02]' />
            ...
            <div className='absolute left-0 w-full bottom-0  z-10 flex flex-col items-start p-6 space-y-4'>
              <h1 className='uppercase font-bold'>
                <span className='text-2xl'>runnig</span>
                <br />
          ...
          {/** card */}
          <div className='break-inside overflow-hidden relative rounded-xl mb-4 text-white'>
            <img src='https://images.pexels.com/photos/13344100/pexels-photo-13344100.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2' alt='Running' className='w-full h-[20rem] object-cover' />
            <div className='absolute top-0 left-0 w-full h-full transition-all bg-[#0000004a]' />
            <div className='absolute left-0 w-full bottom-0 z-10 flex flex-row items-center justify-between p-6 bg-gradient-to-t from-[#000000ed] to-[#00000000]'>
              <a href='#' className='flex items-center font-medium space-x-1'>
          ...
          {/** card */}
          <div className='break-inside overflow-hidden relative rounded-2xl mb-4 text-sm text-white'>
            <img src='https://images.pexels.com/photos/1081685/pexels-photo-1081685.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2' alt='Running' className='w-full h-[36rem] object-cover transition-all group-hover:scale-[1.02]' />
            <div className='absolute left-0 w-full bottom-0  z-10 flex flex-col items-start p-6 space-y-4 bg-gradient-to-t from-[black] to-[#00000000]'>
              <h1 className='uppercase font-bold'>
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elitsed do eiusmod.</p>
              <div className='flex items-center space-x-4'>
                <span className='flex items-center font-medium text-base space-x-1'>
                ...
                <span className='flex items-center font-medium text-base space-x-1'>
                  <svg fill='white' width='26' height='26' version='1.1' id='lni_lni-android-original' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 64 64'>
              ...
              <button className='inline-flex items-center justify-center px-4 py-2 text-sm space-x-3 uppercase font-bold rounded-full w-full bg-[#00fbc1] text-black'>
          ...
          <div className='break-inside flex flex-col justify-between rounded-xl mb-4 text-sm overflow-hidden bg-white dark:bg-slate-800 dark:text-slate-50'>
            <div className='p-4 bg-yellow-50 dark:bg-slate-700'>
              <div className='flex justify-between items-center flex-col space-y-4'>
                <div className='flex flex-col items-center text-center space-y-2'>
                  <img className='flex-none w-24 h-24 rounded-full object-cover' src='https://randomuser.me/api/portraits/women/61.jpg' alt='avatar' />
                  <div>
                    <h5 className='text-lg font-medium'>Orianna</h5>
            ...
            <div className='p-4 flex flex-col w-full space-y-4'>
              ...
              <div className='flex justify-between items-start'>
                <button className='inline-flex justify-center items-center rounded-md uppercase py-2 px-4 font-bold tracking-wide text-xs transition-all bg-slate-800 text-white dark:text-black hover:bg-black dark:bg-slate-100 dark:hover:bg-white dark:hover:text-black'>View profile</button>
                <button className='flex items-center justify-center rounded-full p-1 transition-all hover:bg-slate-200 dark:hover:bg-slate-700'>
                  <svg width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                    <path d='M12,16A2,2 0 0,1 14,18A2,2 0 0,1 12,20A2,2 0 0,1 10,18A2,2 0 0,1 12,16M12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12A2,2 0 0,1 12,10M12,4A2,2 0 0,1 14,6A2,2 0 0,1 12,8A2,2 0 0,1 10,6A2,2 0 0,1 12,4Z' fill='currentColor' />
                  </svg>
